...
static TTYR_TERMINAL_RESULT ttyr_terminal_initOpenGLDimProgram(
    ttyr_terminal_OpenGLDim *Dim_p, nh_gfx_OpenGLCommandBuffer *CommandBuffer_p)
{
...
static TTYR_TERMINAL_RESULT ttyr_terminal_initOpenGLDimVertices(
    ttyr_terminal_OpenGLDim *Dim_p, nh_gfx_OpenGLCommandBuffer *CommandBuffer_p)
{
...
static TTYR_TERMINAL_RESULT ttyr_terminal_updateOpenGLDimVertices(
    ttyr_terminal_OpenGLDim *Dim_p, nh_gfx_OpenGLCommandBuffer *CommandBuffer_p, nh_core_Array *Vertices_p,
    ...
    void *state_p, void *data_p)
{
    ...
    if (Data_p->Dim.Action.init) {
        ttyr_terminal_initOpenGLDimProgram(&Data_p->Dim.OpenGL, 
            State_p->Viewport_p->OpenGL.CommandBuffer_p);
        ttyr_terminal_initOpenGLDimVertices(&Data_p->Dim.OpenGL, 
            State_p->Viewport_p->OpenGL.CommandBuffer_p);
        Data_p->Dim.Action.init = false;
    }

    ttyr_terminal_updateOpenGLDimVertices(&Data_p->Dim.OpenGL,
...
{
    memset(Dim_p, 0, sizeof(ttyr_terminal_OpenGLDim));
