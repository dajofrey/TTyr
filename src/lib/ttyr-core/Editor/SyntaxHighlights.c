...
//// INIT ============================================================================================
//
//static TTYR_CORE_RESULT ttyr_core_insertHighlightWord(
...
//}
//
//nh_encoding_UTF32String ttyr_core_highlightWord(
...
//
//            if (match) {
//                ttyr_core_insertHighlightWord(&NewString, Word, prefix_p, suffix_p);
//                i += Word.length - 1;
//                continue;
//            }
//        }
...
//}
//
//nh_encoding_UTF32String ttyr_core_highlightWords(
...
//        nh_encoding_UTF32String NewString = ttyr_core_highlightWord(Word, String_p, prefix_p, suffix_p);
...
//TTYR_CORE_BEGIN()
//
//    nh_encoding_UTF32String String1 = ttyr_core_highlightWords(
//        cTypeKeywords_pp, sizeof(cTypeKeywords_pp) / sizeof(cTypeKeywords_pp[0]), String_p, "\e[0;32m", "\e[0m"
//    ); 
//    nh_encoding_UTF32String String2 = ttyr_core_highlightWords(
