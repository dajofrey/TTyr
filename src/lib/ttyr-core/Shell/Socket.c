...
static void ttyr_core_setUDSFilePath(
...
{
    char path_p[255] = {0};
    ttyr_core_setUDSFilePath(path_p, pid);
...
//        ttyr_core_addProgram(nh_core_getWorkloadArg(), ttyr_core_createProgramPrototype(type), true);
    }
...
TTYR_CORE_RESULT ttyr_core_sendCommandToShell(
