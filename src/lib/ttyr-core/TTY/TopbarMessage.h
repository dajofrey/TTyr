...
typedef struct ttyr_core_Topbar ttyr_core_Topbar;
 ...
 */
    ...
    TTYR_CORE_RESULT ttyr_core_setCustomMessage(
        ttyr_core_Topbar *Topbar_p, NH_API_UTF32 *suffix_p, int suffixLength
    );

    TTYR_CORE_RESULT ttyr_core_setCustomSuffixMessage(
        ttyr_core_Topbar *Topbar_p, TTYR_CORE_MESSAGE prefix, NH_API_UTF32 *suffix_p, 
        int suffixLength
    );
